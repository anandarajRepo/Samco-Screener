...
samco.set_session_token(sessionToken="92ce3556414b71b90ec308ed0eb83e96")
...
try:
    ...
    for nse_company in nse_companies:
        if "SECTOR" in nse_company and "SUBSECTOR" in nse_company:
            ...
            print(nse_company["SYMBOL"])
            time.sleep(1)
            HistoricalCandleData = samco.get_historical_candle_data(symbol_name=nse_company["SYMBOL"], exchange=samco.EXCHANGE_NSE, from_date='2021-05-21', to_date='2021-09-04')
            dictHistoricalData = json.loads(HistoricalCandleData)
